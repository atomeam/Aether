...
export function ANYapinexusrouteintegrationId() {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:3000/api/nexus/route/:integrationId/*');
      if (!response.ok) {
