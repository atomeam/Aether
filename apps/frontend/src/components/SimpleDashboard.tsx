...
import { ArrowUpRight, Sparkles, TrendingUp, Shield, Zap, Users, Gift, Copy, Check } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-8 py-16">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="group bg-gradient-to-r from-[#c4a661] to-[#d4b671] text-black font-bold px-8 py-4 rounded-full text-lg hover:shadow-lg hover:shadow-[#c4a661]/30 transition-all flex items-center gap-2">
