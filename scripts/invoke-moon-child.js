...
/**
 * Invoke MCP tool to store Moon Child review in agent reflection system
 */

const API_URL = 'http://localhost:3002/api/mcp/invoke';

async function invokeMCP() {
  const requestData = {
    toolName: "agent_reflect",
    args: {
  ...
  try {
    console.log('Invoking MCP tool: agent_reflect');
